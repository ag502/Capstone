...
class ClipVideoDownloader(APIView):
    ...
    def post(self, request):
        ...
        output_dir = 'C:/Users/jaehee/capstone/Material_Ui_Capstone/backend/clippingVideo/'  # 영상 저장경로, 후에 s3로 변경
        thumnail_dir = 'C:/Users/jaehee/capstone/Material_Ui_Capstone/backend/thumnails/'
